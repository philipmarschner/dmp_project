...
admittanceController = Admitance(robot, 25, 25,Tc = Tc)
...
for i in range(25000):
    ...
    admdata = np.concatenate([admdata, refTrajectory(t)+admittanceController.getDeltaqPos()],axis=1)
...
ofig.suptitle('Vertically stacked subplots')
